...
function AboutHero() {
  return (
    ...
    >
      <div className="container flex flex-col lg:min-h-200 sm:items-center justify-center  md:h-[calc(100dvh-96px)] xl:h-[calc(100dvh-128px)] gap-4 lg:gap-6  text-white pt-20">
        ...
        <div className="rounded-4xl overflow-hidden  relative w-full sm:w-140 md:w-160 lg:w-4xl h-64 xl:w-[996px] sm:h-96 lg:h-[500px] xl:h-[544px]">
          <Image
            src={team}
